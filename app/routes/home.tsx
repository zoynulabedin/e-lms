    ...
    <div className="space-y-7">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            href="/reports/export"
            className="flex items-center gap-2 text-sm font-medium text-white bg-brand-navy hover:bg-brand-navy-dark px-4 py-2 rounded-lg transition-colors shadow-sm"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 flex items-center gap-5">
          ...
          <Link
            to="/courses"
            className="shrink-0 flex items-center gap-1 text-xs text-brand-navy font-semibold hover:text-brand-navy-dark transition-colors"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {totalTrend === 0 ? (
            ...
            <div className="flex items-end gap-1 h-36">
              {trend.map((d, i) => (
                ...
                >
                  {d.count > 0 && (
                    <span className="text-[10px] text-brand-navy font-semibold opacity-0 group-hover:opacity-100 transition-opacity">
                      {d.count}
                    </span>
                  )}
                  <div
                    className={`w-full rounded-t-sm transition-colors ${
                      d.count > 0
                        ? "bg-brand-navy/80 group-hover:bg-brand-navy"
                        : "bg-gray-100"
                    }`}
                    style={{
                      height: `${Math.max(
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link
              to="/courses"
              className="text-xs text-brand-navy hover:text-brand-navy-dark font-medium transition-colors"
            >
              View all
            </Link>
          </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          ...
          <Link
            to="/licenses"
            className="text-xs text-brand-navy hover:text-brand-navy-dark font-medium transition-colors flex items-center gap-1"
          >
        ...
        {recentActivity.length === 0 ? (
          ...
          <div className="divide-y divide-gray-50">
            {recentActivity.map((a: any) => (
              ...
              >
                <div className="shrink-0 w-8 h-8 rounded-full bg-brand-navy/10 text-brand-navy flex items-center justify-center font-bold text-xs">
