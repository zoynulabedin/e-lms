    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[#2C795A] text-white px-4 py-2 rounded-md font-medium text-sm hover:bg-[#225A43] transition-colors shadow-sm"
        >
        ...
        <div className="p-4 border-b border-gray-200 flex flex-wrap gap-4 items-center justify-between">
          <Form method="get" className="flex items-center gap-2">
            ...
            <select
              ...
              className="text-sm border-gray-300 rounded-md shadow-sm focus:border-[#2C795A] focus:ring-[#2C795A] py-1.5 pl-3 pr-8"
            >
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
              <h3 className="text-base font-semibold text-gray-900 flex items-center gap-2">
                <Key size={16} className="text-[#2C795A]" /> Generate Bulk
                License Keys
              </h3>
              <button
            ...
            <fetcher.Form method="post" className="p-6 space-y-4">
              ...
              <div>
                ...
                {courses.length === 0 ? (
                  ...
                  <select
                    ...
                    required
                    defaultValue=""
                    className="w-full border border-gray-300 rounded-lg shadow-sm focus:border-[#2C795A] focus:ring-[#2C795A] py-2 pl-3 pr-8 text-sm"
                  >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg shadow-sm focus:border-[#2C795A] focus:ring-[#2C795A] py-2 px-3 text-sm"
                />
              ...
              <div className="pt-2 flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium text-white bg-[#2C795A] rounded-lg hover:bg-[#225A43] transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                >
