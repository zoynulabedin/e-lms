...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .badge { display: inline-flex; align-items: center; justify-content: center; width: 72px; height: 72px; background: linear-gradient(135deg, #2C795A, #C69445); border-radius: 50%; margin-bottom: 28px; }
    ...
    .name { font-size: 32px; font-weight: 700; color: #2C795A; margin-bottom: 8px; }
    ...
    .divider { width: 80px; height: 3px; background: linear-gradient(90deg, #2C795A, #C69445); border-radius: 2px; margin: 28px auto; }
...
<body>
  <div class="cert">
    ...
    <div style="margin-top:40px;">
      <button onclick="window.print()" class="no-print" style="background:#2C795A;color:#fff;border:none;padding:10px 28px;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer;font-family:Inter,sans-serif;">
