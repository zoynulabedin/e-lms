  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        ...
        <a
          href="/reports/export"
          className="flex items-center gap-2 text-sm text-brand-navy border border-brand-navy/30 hover:bg-brand-navy/5 px-4 py-2 rounded-lg transition-colors font-medium"
        >
          ...
          <div className="flex items-end gap-2 h-40">
            {licensesByDay.map((d) => (
              ...
              >
                ...
                <div
                  className="w-full rounded-t-md bg-brand-navy hover:bg-brand-navy-dark transition-colors"
                  style={{
